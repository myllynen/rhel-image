...
# How many retries to check for the build status
rhel_image_build_check_retries: 30
# How long delay between each build status check
rhel_image_build_check_delay: 30
